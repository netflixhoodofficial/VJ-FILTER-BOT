...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '7539069968').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001886992798') # give your force subscribe channel id here else leave it blank
...
COLLECTION_NAME = environ.get('netflix', 'vjcollection')
